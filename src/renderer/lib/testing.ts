...
function defaultCairn(): CairnAPI {
  return {
    ...
    githubStatus: async () => ({ ok: true, data: { source: "anonymous", connected: false, login: null, ghCliDetected: false, accounts: [], activeLogin: null } }),
    githubAddAccount: async () => ({ ok: true, data: { login: "octocat" } }),
